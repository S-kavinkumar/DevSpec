...
import com.devspec.security.CustomUserDetailsService;
import com.devspec.security.JwtAuthenticationFilter;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                .requestMatchers("/api/projects/download/**").permitAll() // Expose report download
                .requestMatchers("/api/projects/progress/**").permitAll() // Expose progress SSE stream
